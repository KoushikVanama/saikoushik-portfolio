...
const ContactForm = () => {
    ...
    return (
        <div className="flex flex-col text-center justify-center bg-slate-800 h-full w-full">
            <h1 className="text-center text-white font-bold text-2xl">CONTACT</h1>
            ...
            <div className="form-wrapper flex justify-center gap-y-2 my-8">
                <form className="flex flex-col gap-y-1 w-[25rem] items-center" onSubmit={handleSubmit(onSubmit)}>
                    <input placeholder="Your name" className="p-1 w-full bg-none border-2 border-gray-600 focus:border-primary-color placeholder:text-black" autoComplete="off" {...register("name", { required: true, minLength: 1, maxLength: 20 })} />
                    ...
                    <input placeholder="Your e-mail" className="p-1 w-full bg-none border-2 border-gray-600 focus:border-primary-color placeholder:text-black" autoComplete="off" {...register("email", {
                    ...
                    <textarea placeholder="Your message" className=" w-full p-2 bg-none border-2 border-gray-600 focus:border-primary-color min-h-[8rem] placeholder:text-black" autoComplete="off" {...register("message", { required: false, minLength: 1 })} />
                    <button className="flex my-5 p-2 justify-center border-2 border-white w-[8rem] text-white hover:bg-primary-color hover:text-slate-900" type="submit">SUBMIT</button>
                </form>
            </div>
        </div >
    )
